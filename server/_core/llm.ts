...
// OpenRouter recommends sending attribution headers; they are optional but
// used for analytics and app rankings on openrouter.ai.
const buildHeaders = (): Record<string, string> => ({
  "content-type": "application/json",
  authorization: `Bearer ${ENV.forgeApiKey}`,
  "HTTP-Referer": ENV.llmReferer,
  "X-Title": ENV.llmTitle,
});
...
export async function invokeLLM(params: InvokeParams): Promise<InvokeResult> {
  ...
  const payload: Record<string, unknown> = {
    ...
    // OpenRouter requires an explicit model; fall back to the configured default.
